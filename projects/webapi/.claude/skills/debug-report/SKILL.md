---
name: debug-report
description: "报表调试：报表查询慢、导出 OOM、报表数据不对。检查 Join、Select 投影、WhereIF、foreach 查库、枚举显示。触发关键词：报表慢、报表导出、报表数据不对、Report、ExportDto、FillDetailDataAsync、导出 OOM、PagedQueryDto、报表 Join。"
shell: powershell
version: 1.0.0
---
